...
Dispatch the Product Designer to produce screen specs and Claude Design brief.
...
```
Task: Phase 2 — Screen Specs + Claude Design Brief
...
2. artifacts/docs/claude-design-brief.md — structured input for human to use in Claude Design
