# Extracting Reusable Primitives — Reference

This reference documents the philosophy and mechanics of pulling reusable components and tokens out of feature code into a shared design system. In RAD's pipeline, this happens during Foundation Step 1 when the frontend-developer catalogs the adapter's components into `artifacts/docs/design-system-spec.md`, and iteratively during Feature Mode when new screens surface primitives worth promoting.

Use this reference when deciding: "should this piece of code be a reusable primitive, or stay local to its feature?"
