...
|---|---|---|
| `design-tool-log.md` | Prompt patterns that produced clean handoffs; failure modes encountered; brief structures that worked | Product Designer on every `/design` session end |
...
- **At `/phase2`:** Product Designer reads `design-tool-log.md` before writing the brief. Winning prompt structures inform the new brief.
