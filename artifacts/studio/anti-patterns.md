...
```
### [short name of the anti-pattern]

**Tried on:** [app-slug], [YYYY-MM-DD]
**Symptom at launch:** [one-line]
**Root cause:** [one-line]
**Rule going forward:** [one-line imperative — what to do instead]
```
...
*No entries yet. First post-launch post-mortem that surfaces a confirmed anti-pattern will seed this.*
